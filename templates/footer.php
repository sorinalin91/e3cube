...
<div class="col-xs-12 col-md-12 col-lg-12 footer">
  ...
  <div class="dummy dummy-footer" style="padding-top:8%"></div>
  <div class="grid-container footer-grid-container">
    ...
    <div class="copy" style="color:#131e29;">&copy; All rights reserved. E3 Cube Ltd. Incorporated in England &amp; Wales, No.8524588. Registered Office: 23 Meridian Business Village, Hunts Cross, Liverpool, L24 9LG.</div>
...
<!-- <div class="col-xs-4 col-md-4 col-lg-4 footer">
  <div class="nav-bg-filter nav navbar-nav navbar-right filter-hover"></div>
  <div class="dummy dummy-footer" style="padding-top:20%"></div>
