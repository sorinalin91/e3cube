      ...
      <div class="dummy" style="padding-top: 95.6%"></div>
        <div class="grid-container">
	      <div class="text-padding filter-hover-text">
	        ...
	        <p class="padding-50-0-0-50 first-p-without-title strategic-12-grid-p" style="margin-bottom: 5px;">Competence.</p>
          <p class="padding-left-50" style="font-style:italic;">Comply with statutory duties.</p>
          <p class="padding-left-50" style="font-style:italic;">Risk removal or mitigation.</p>
	        <p class="padding-left-50" style="font-style:italic;">Safety during the construction, maintenance and occupation. </p>
	      </div>
    	</div>
    </div>
      ...
      <div class="dummy" style="padding-top: 95.8%"></div>
        <div class="grid-container">
          <div class="text-padding filter-hover-text">
            <h2 class="padding-20-0-0-50 nbsp-h2">&nbsp;</h2>
            <span class="blue-border hidden-mobile-p"></span>
            <p class="padding-50-0-0-50 first-p-without-title strategic-12-grid-p" style="margin-bottom: 5px;">Training. </p>
