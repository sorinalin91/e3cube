...
<div class="col-xs-5 col-md-5 col-lg-5 block-item no-padding light-background">
      ...
      <div class="dummy" style="padding-top: 95.6%"></div>
        <div class="grid-container">
	      <div class="text-padding filter-hover-text">
	        ...
	        <p class="padding-left-50 strategic-12-grid-p" style="font-style:italic;">"They achieved the impossible in a very short period of time, securing the College significant levels of EFA funding for our new £5m Visitor Economy Centre"</p><br />
	        <p class="padding-left-50 strategic-12-grid-p" style="font-style:italic;">"E3 Cube have a detailed understanding of the challenges and needs within the Education Sector, being able to draw upon this knowledge has been invaluable" Vice Principal</p>
	      </div>
    	</div>
    </div>
    <div class="col-xs-7 col-md-7 col-lg-7 no-padding block-item">
      ...
      <div class="dummy" style="padding-top:68.3%"></div>
        <div class="grid-container">
          <h2 class="image-title strategic-12-col-grid-h2">ACCRINGTON &amp; ROSSENDALE COLLEGE<br />VISITOR ECONOMY CENTRE
</h2>
    ...
    <div class="col-xs-7 col-md-7 col-lg-7 no-padding block-item">
      ...
      <div class="dummy" style="padding-top:68.3%"></div>
        <div class="grid-container">
          <h2 class="image-title strategic-12-col-grid-h2">EXPERTS IN FUNDING, INCLUDING:<br />ENHANCED RENEWAL GRANT FUND<br />COLLEGE CAPITAL INVESTMENT FUND<br />SKILLS INFRASTRUCTURE CAPITAL FUND<br />COLLEGE CONDITION FUND<br />BUILDING CONDITION IMPROVEMENT FUND<br />ACADEMIES CAPITAL MAINTENANCE FUND<br />CONDITION IMPROVEMENT FUND<br />SPORT ENGLAND<br />SALIX<br />LOCAL ENTERPRISE PARTNERSHIP FUNDING</h2>
    ...
    <div class="col-xs-5 col-md-5 col-lg-5 block-item no-padding light-background">
      ...
      <div class="dummy" style="padding-top: 95.8%"></div>
        <div class="grid-container">
          <div class="text-padding filter-hover-text">
            <span class="blue-border hidden-mobile-p"></span>
            <p class="padding-50-0-0-50 strategic-12-grid-p">“E3 Cube quickly established our priority needs and completed detailed due diligence to develop robust business cases for CIF funding support”</p>
            <p class="padding-left-50">“With E3 Cubes support, we secured funding for both of our bids, without their support this would not have been possible”</p>
