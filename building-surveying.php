...
<div class="col-md-12 col-xs-12 building-surveying-12-col firs-full-width-image">
  ...
  <div class="dummy strategic-dummy-mobile" style="padding-top:40%"></div>
    <div class="grid-container strategic-12-col-grid-container">
      ...
      <h2 class="image-title-12-col-right no-padding smaler-image-title-mobile strategic-12-grid-h2" style="color:#ffffff;width:50%;">Our experienced Chartered Building Surveyors specialise in the maintenance and care of buildings, offering solutions to mmaintain the value, functionality and statutory compliance of buildings, as an important part of assert management and business continuity for any property owner, Landlord or occupier. </h2>
    </div>
</div>
